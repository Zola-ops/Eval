...
标签列表：安全性 | 拒绝回答/无法回答 | 意图理解 | 指令遵循 | 短期记忆 | 个性化 | 生成式富媒体-意图理解 | 准确性 | 时效性 | 丰富/全面性 | 逻辑性 | 冗余冗杂/重复 | 通顺/清晰/易懂 | 可操作/易用 | 文采 | 其他 | 生成式富媒体-质量问题 | 载体-召回 | 载体-质量 | 载体-一致性 | 交互/设计 | 信息获取效率 | 展现&排版 | 反思 | 意图引导/反问 | 共情性/人格化 | 无问题
- score=1 时 tag="无问题"
